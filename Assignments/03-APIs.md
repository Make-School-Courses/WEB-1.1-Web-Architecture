...
In a terminal window, navigate to your newly created folder and clone the [starter code](https://github.com/Make-School-Labs/WEB-1.1-Homework-3-Starter):

```
$ git clone git@github.com:Make-School-Labs/WEB-1.1-Homework-3-Starter.git Homework-1-Request-Response
```
